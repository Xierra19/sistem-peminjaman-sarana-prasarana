          ...
          <section class="rounded-xl border border-gray-200 bg-white shadow-sm">
            <header class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
              <div class="space-y-1">
                ...
                <p class="text-sm text-gray-500">Informasi lengkap mengenai request yang diajukan oleh user.</p>
              </div>
              <span
            ...
            <div class="grid gap-6 px-6 py-5 sm:grid-cols-2">
              ...
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-700">Ruangan: <span class="font-semibold text-gray-900">{{ booking.room?.name ?? '-' }}</span></p>
          ...
          <section class="rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="space-y-4 px-6 py-5">
              ...
              <div class="flex flex-col gap-2">
                <button
                  type="button"
                  class="inline-flex items-center justify-center rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-60"
                  :disabled="approvalForm.processing || !isPending"
                ...
                <button
                  type="button"
                  class="inline-flex items-center justify-center rounded-md bg-rose-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
                  :disabled="approvalForm.processing || !isPending"
              ...
              <p v-if="!isPending" class="text-xs text-gray-400">
