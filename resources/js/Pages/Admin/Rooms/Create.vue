...
<template>
  ...
  <AuthenticatedLayout>
    <div class="bg-white p-6 rounded-lg shadow-md max-w-lg">
      <h1 class="text-xl font-semibold text-gray-800 mb-4">➕ Tambah Ruangan</h1>
      ...
      <form @submit.prevent="submit" class="space-y-4">
        ...
        <div>
          ...
          <p class="mt-1 text-xs text-gray-400">Nonaktifkan jika ruangan sedang tidak dapat digunakan sementara.</p>
